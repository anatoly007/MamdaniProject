...
//        double b[] = controller.fuzzification(new double[]{0.5, 0.5});
...
//        ts2.setTerm("уд.", new TrapFunc(0.4, 0.5, 0.6, 0.7));
//        ts2.setTerm("хор.", new TrapFunc(0.6, 0.7, 0.8, 0.9));
//        ts2.setTerm("отл.", new TrapFunc(0.8, 0.9, 1, 1));
//        LingVariable x2 = new LingVariable("input2", ts2);
//        variables.put("X2", x2);
//
//        TermSet ts3 = new TermSet();
//        ts3.setTerm("низкий", new TrapFunc(0, 0, 0.3, 0.4));
//        ts3.setTerm("средний", new TrapFunc(0.3, 0.4, 0.7, 0.8));
//        ts3.setTerm("высокий", new TrapFunc(0.7, 0.8, 1, 1));
